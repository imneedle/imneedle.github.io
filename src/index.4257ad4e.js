...
const barInterval = setInterval(()=>{
    ...
    if (currentWidth === 101) {
        ...
        (0, _gsap.gsap).to(".loading__bar", {
            duration: 5,
            rotate: "180deg",
            left: "1000%"
        });
        (0, _gsap.gsap).to(".loading__text, .loading__counter", {
            duration: 0.5,
            opacity: 0
        });
        (0, _gsap.gsap).to(".loading__box", {
            duration: 1,
            borderRadius: "50%",
            height: "50rem"
        });
        (0, _gsap.gsap).to(".loading__svg", {
            duration: 10,
            opacity: 1,
            rotate: "360deg"
        });
        ...
        (0, _gsap.gsap).to(".header", {
            duration: 2,
            delay: 2,
            top: "0"
        });
        (0, _gsap.gsap).to(".scroll-down", {
            duration: 2,
            delay: 3,
            bottom: "4.8rem",
            opacity: 1
        });
        (0, _gsap.gsap).to(".introduction", {
            duration: 1.5,
            delay: 4,
            left: "2rem"
        });
...
},{"gsap":"fPSuC","./swiper":"evkzr","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fPSuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"evkzr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _swiper = require("swiper");
...
const swiper = new (0, _swiper.Swiper)(".swiper", {
    slidesPerView: 3,
    spaceBetween: 30,
    pagination: {
...
function loopCreate() {
    ...
    for(let i1 = prependSlides.length - 1; i1 >= 0; i1 -= 1)$selector.prepend((0, _domJsDefault.default)(prependSlides[i1].cloneNode(true)).addClass(params.slideDuplicateClass));
}
...
},{"../../shared/create-shadow.js":"9JYAP","../../shared/effect-init.js":"5DnvG","../../shared/effect-target.js":"eKqS8","../../shared/effect-virtual-transition-end.js":"VhYFx","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["lHRxv","9OMkf"], "9OMkf", "parcelRequire2041")
